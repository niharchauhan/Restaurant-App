                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        model=".firstname"
                                        // Show only after item is touched
                                        show="touched"
                                        messages={{
                                            // if required, minLength, maxLength is true than messages will be displayed
                                            required: 'Required',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        show="touched"
                                        messages={{
                                            // if required, minLength, maxLength, isNumber is true than messages will be displayed
                                            required: 'Required',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors
                                        ...
                                        show="touched"
                                        messages={{
                                            // if required, validEmail is true than messages will be displayed
                                            required: 'Required',
