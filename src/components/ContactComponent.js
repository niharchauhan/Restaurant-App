...
class Contact extends Component {
    constructor(props) {
        ...
        // in order to make available handleSubmit()
        this.handleSubmit = this.handleSubmit.bind(this);
        // in order to make available handleInputChange()
        this.handleInputChange = this.handleInputChange.bind(this);
        // in order to make available handleBlur()
    ...
    handleSubmit(event) {
        ...
        // prevents from going to next page
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        // Only digits
        const reg = /^\d+$/;
        // test() will test the regular expression specified with the input and returns true or false
        if(this.state.telnum && !reg.test(telnum)) {
            errors.telnum = 'Tel. Number should contain only numbers';
        }

        // Checking there should be atleast one @ character
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                <Col md={{size: 6, offset: 2}}>
                                    <FormGroup check>
                                        <Label check>
                                            <Input type="checkbox" name="agree" checkbox={this.state.agree} onChange={this.handleInputChange} />{' '}<strong>May we contact you?</strong>
                                        </Label>
                                    </FormGroup>
                                </Col>
